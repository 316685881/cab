...
Revision ID: 307a4d71b1ae
Revises: 
Create Date: 2019-06-30 15:58:19.007255
...
def upgrade():
    ...
    op.create_table('cab_user_profile',
    sa.Column('create_time', sa.DateTime(), nullable=True),
    sa.Column('update_time', sa.DateTime(), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('name', sa.String(length=32), nullable=False),
    ...
    sa.ForeignKeyConstraint(['area_id'], ['cab_area_info.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['cab_user_profile.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_table('cab_car_facility',
    sa.Column('car_id', sa.Integer(), nullable=False),
    sa.Column('facility_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['car_id'], ['cab_car_info.id'], ),
    sa.ForeignKeyConstraint(['facility_id'], ['cab_facility_info.id'], ),
    ...
    op.create_table('cab_order_info',
    sa.Column('create_time', sa.DateTime(), nullable=True),
    sa.Column('update_time', sa.DateTime(), nullable=True),
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('user_id', sa.Integer(), nullable=False),
    ...
    op.create_index(op.f('ix_cab_order_info_status'), 'cab_order_info', ['status'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_cab_order_info_status'), table_name='cab_order_info')
    op.drop_table('cab_order_info')
    op.drop_table('cab_car_image')
    op.drop_table('cab_car_facility')
    op.drop_table('cab_car_info')
    op.drop_table('cab_user_profile')
    op.drop_table('cab_facility_info')
    op.drop_table('cab_area_info')
    # ### end Alembic commands ###
